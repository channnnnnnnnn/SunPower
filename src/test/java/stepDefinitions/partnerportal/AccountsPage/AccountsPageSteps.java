...
public class AccountsPageSteps extends BasePage {
	...
	@When("^User creates a Commercial Customer account$")
	public void user_creates_a_Commercial_Customer_account() throws Exception {
		AccountsPage accountsPage = new AccountsPage();
		accountsPage.createNewCommercialCustomerAccount();	    
	}
