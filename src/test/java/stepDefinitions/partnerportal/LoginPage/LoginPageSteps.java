...
public class LoginPageSteps {
	...
	public void user_logs_in_as_eugene_buen_in_qa() throws Exception {
		LoginPage loginPage = new LoginPage();
		loginPage.loginAsEugeneBuenQA(Constant.QAIndirectPartnerEugeneBuenUser, Constant.QAIndirectPartnerEugeneBuenPass);
	}
